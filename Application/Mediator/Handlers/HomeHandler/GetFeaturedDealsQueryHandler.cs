...
{
    public class GetFeaturedDealsQueryHandler : IRequestHandler<GetFeaturedDealsQuery, IEnumerable<FeaturedDealDto>>
    {
        ...
        public async Task<IEnumerable<FeaturedDealDto>> Handle(GetFeaturedDealsQuery request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<IEnumerable<FeaturedDealDto>>(rooms);
        }
    }
}
